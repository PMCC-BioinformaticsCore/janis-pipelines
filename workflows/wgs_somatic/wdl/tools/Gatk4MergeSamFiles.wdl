...
task Gatk4MergeSamFiles {
  input {
    ...
    Array[File] bams
    Array[File] bams_bai
    String outputFilename = "generated-f5ac65e6-e018-11e9-af76-a0cec8186c53.bam"
  ...
  command {
    ...
    gatk MergeSamFiles \
      ...
      -I ${sep=" " bams} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-f5ac7298-e018-11e9-af76-a0cec8186c53.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-f5ac65e6-e018-11e9-af76-a0cec8186c53.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-f5ac65e6-e018-11e9-af76-a0cec8186c53.bam", "\\.bam$", ".bai")
  }
}