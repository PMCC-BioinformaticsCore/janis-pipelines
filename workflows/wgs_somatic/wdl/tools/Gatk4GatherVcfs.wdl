...
task Gatk4GatherVcfs {
  input {
    ...
    Int? runtime_memory
    Array[File] vcfs
    String outputFilename = "generated-0666b304-c2dd-11e9-933b-f218985ebfa7.gathered.vcf"
  ...
  command {
    gatk GatherVcfs \
      ...
      ${"--OUTPUT " + if defined(outputFilename) then outputFilename else "generated-0666c06a-c2dd-11e9-933b-f218985ebfa7.gathered.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-0666b304-c2dd-11e9-933b-f218985ebfa7.gathered.vcf"
  }
}