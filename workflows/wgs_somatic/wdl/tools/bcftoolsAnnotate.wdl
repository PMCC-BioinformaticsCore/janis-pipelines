...
task bcftoolsAnnotate {
  input {
    ...
    Int? runtime_memory
    File file
    String outputFilename = "generated-066850e2-c2dd-11e9-933b-f218985ebfa7.vcf"
    File? annotations
    String? collapse
  ...
  command {
    bcftools annotate \
      ${"--output " + if defined(outputFilename) then outputFilename else "generated-06685b8c-c2dd-11e9-933b-f218985ebfa7.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-066850e2-c2dd-11e9-933b-f218985ebfa7.vcf"
  }
}