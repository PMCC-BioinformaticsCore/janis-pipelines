...
task Gatk4MergeSamFiles {
  input {
    ...
    Array[File] bams
    Array[File] bams_bai
    String outputFilename = "generated-fa912786-e018-11e9-8aa4-a0cec8186c53.bam"
  ...
  command {
    ...
    gatk MergeSamFiles \
      ...
      -I ${sep=" " bams} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-fa913474-e018-11e9-8aa4-a0cec8186c53.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-fa912786-e018-11e9-8aa4-a0cec8186c53.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-fa912786-e018-11e9-8aa4-a0cec8186c53.bam", "\\.bam$", ".bai")
  }
}