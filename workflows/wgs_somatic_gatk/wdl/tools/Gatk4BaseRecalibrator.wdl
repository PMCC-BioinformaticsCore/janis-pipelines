...
task Gatk4BaseRecalibrator {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-fa919c52-e018-11e9-8aa4-a0cec8186c53.table"
    File? intervals
  }
  command {
    ...
    gatk BaseRecalibrator \
      ...
      -R ${reference} \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-fa91a328-e018-11e9-8aa4-a0cec8186c53.table"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-fa919c52-e018-11e9-8aa4-a0cec8186c53.table"
  }
}