...
task gatk4sortsam {
  input {
    ...
    Int? runtime_memory
    File bam
    String outputFilename = "generated-fa90e550-e018-11e9-8aa4-a0cec8186c53.bam"
    String sortOrder
  ...
  command {
    ...
    gatk SortSam \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-fa90ef3c-e018-11e9-8aa4-a0cec8186c53.bam"} \
      -SO ${sortOrder} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-fa90e550-e018-11e9-8aa4-a0cec8186c53.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-fa90e550-e018-11e9-8aa4-a0cec8186c53.bam", "\\.bam$", ".bai")
  }
}