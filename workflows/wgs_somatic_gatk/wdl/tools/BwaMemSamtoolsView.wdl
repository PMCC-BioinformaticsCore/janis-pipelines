...
task BwaMemSamtoolsView {
  input {
    ...
    Array[File] reads
    Array[File]? mates
    String outputFilename = "generated-9c2e5e20-c2e5-11e9-91cd-f218985ebfa7.bam"
    String sampleName
  ...
  command {
     \
      ...
      samtools \
      view \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-9c2e759a-c2e5-11e9-91cd-f218985ebfa7.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-9c2e5e20-c2e5-11e9-91cd-f218985ebfa7.bam"
  }
}