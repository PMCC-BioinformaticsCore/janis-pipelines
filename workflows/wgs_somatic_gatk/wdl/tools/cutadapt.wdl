...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-98eb1908-cf9f-11e9-a6a4-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-98eb1908-cf9f-11e9-a6a4-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-98eb3a6e-cf9f-11e9-a6a4-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-98eb3a6e-cf9f-11e9-a6a4-acde48001122-R2.fastq.gz"} \
