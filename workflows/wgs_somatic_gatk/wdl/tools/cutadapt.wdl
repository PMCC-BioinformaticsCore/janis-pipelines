...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-37c1c09e-ced9-11e9-8396-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-37c1c09e-ced9-11e9-8396-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-37c1de94-ced9-11e9-8396-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-37c1de94-ced9-11e9-8396-acde48001122-R2.fastq.gz"} \
