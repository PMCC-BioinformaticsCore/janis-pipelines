...
task gatk4sortsam {
  input {
    ...
    Int? runtime_memory
    File bam
    String outputFilename = "generated-d90f5c90-e018-11e9-851b-a0cec8186c53.bam"
    String sortOrder
  ...
  command {
    ...
    gatk SortSam \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-d90f66ae-e018-11e9-851b-a0cec8186c53.bam"} \
      -SO ${sortOrder} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-d90f5c90-e018-11e9-851b-a0cec8186c53.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-d90f5c90-e018-11e9-851b-a0cec8186c53.bam", "\\.bam$", ".bai")
  }
}