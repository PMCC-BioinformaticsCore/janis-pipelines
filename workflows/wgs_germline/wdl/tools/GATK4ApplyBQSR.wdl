...
task GATK4ApplyBQSR {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-d91062ca-e018-11e9-851b-a0cec8186c53.bam"
    File? recalFile
    File? intervals
    String? tmpDir
  }
  command {
    ...
    gatk ApplyBQSR \
      -R ${reference} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-d91069f0-e018-11e9-851b-a0cec8186c53.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-d91062ca-e018-11e9-851b-a0cec8186c53.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-d91062ca-e018-11e9-851b-a0cec8186c53.bam", "\\.bam$", ".bai")
  }
}