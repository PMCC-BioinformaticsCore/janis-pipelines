...
task Gatk4BaseRecalibrator {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-d9104150-e018-11e9-851b-a0cec8186c53.table"
    File? intervals
  }
  command {
    ...
    gatk BaseRecalibrator \
      ...
      -R ${reference} \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-d91048c6-e018-11e9-851b-a0cec8186c53.table"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-d9104150-e018-11e9-851b-a0cec8186c53.table"
  }
}