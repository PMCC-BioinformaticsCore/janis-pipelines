...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-5656d1e6-cf9e-11e9-97c1-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-5656d1e6-cf9e-11e9-97c1-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-5656f036-cf9e-11e9-97c1-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-5656f036-cf9e-11e9-97c1-acde48001122-R2.fastq.gz"} \
