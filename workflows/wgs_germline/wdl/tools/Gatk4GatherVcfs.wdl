...
task Gatk4GatherVcfs {
  input {
    ...
    Int? runtime_memory
    Array[File] vcfs
    String outputFilename = "generated-363dab5e-c3b0-11e9-81d9-f218985ebfa7.gathered.vcf"
  ...
  command {
    gatk GatherVcfs \
      ...
      ${"--OUTPUT " + if defined(outputFilename) then outputFilename else "generated-363db860-c3b0-11e9-81d9-f218985ebfa7.gathered.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-363dab5e-c3b0-11e9-81d9-f218985ebfa7.gathered.vcf"
  }
}