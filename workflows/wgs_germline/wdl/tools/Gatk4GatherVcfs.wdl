...
task Gatk4GatherVcfs {
  input {
    ...
    Int? runtime_memory
    Array[File] vcfs
    String outputFilename = "generated-d910e40c-e018-11e9-851b-a0cec8186c53.gathered.vcf"
  ...
  command {
    gatk GatherVcfs \
      ...
      ${"--OUTPUT " + if defined(outputFilename) then outputFilename else "generated-d910ed08-e018-11e9-851b-a0cec8186c53.gathered.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-d910e40c-e018-11e9-851b-a0cec8186c53.gathered.vcf"
  }
}