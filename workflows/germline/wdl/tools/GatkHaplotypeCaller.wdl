...
task GatkHaplotypeCaller {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-6fbeedbc-befa-11e9-a555-acde48001122.vcf"
    File dbsnp
    File dbsnp_tbi
    File? intervals
  }
  command {
    gatk HaplotypeCaller \
      ...
      --reference ${reference} \
      --dbsnp ${dbsnp} \
      ${"--output " + if defined(outputFilename) then outputFilename else "generated-6fbf14fe-befa-11e9-a555-acde48001122.vcf"}
  }
  runtime {
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-6fbeedbc-befa-11e9-a555-acde48001122.vcf"
    File out_idx = if defined(outputFilename) then outputFilename else "generated-6fbeedbc-befa-11e9-a555-acde48001122.vcf" + ".idx"
  }
}