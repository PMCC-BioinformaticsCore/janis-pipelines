...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-6fbdd472-befa-11e9-a555-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-6fbdd472-befa-11e9-a555-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-6fbde75a-befa-11e9-a555-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-6fbde75a-befa-11e9-a555-acde48001122-R2.fastq.gz"} \
