...
task Gatk4GatherVcfs {
  input {
    ...
    Int? runtime_memory
    Array[File] vcfs
    String outputFilename = "generated-6fbf4ba4-befa-11e9-a555-acde48001122.gathered.vcf"
  ...
  command {
    gatk GatherVcfs \
      ...
      ${"--OUTPUT " + if defined(outputFilename) then outputFilename else "generated-6fbf52d4-befa-11e9-a555-acde48001122.gathered.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-6fbf4ba4-befa-11e9-a555-acde48001122.gathered.vcf"
  }
}