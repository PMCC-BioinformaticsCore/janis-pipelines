...
task bcftoolsAnnotate {
  input {
    ...
    Int? runtime_memory
    File file
    String outputFilename = "generated-6fc05e36-befa-11e9-a555-acde48001122.vcf"
    File? annotations
    String? collapse
  ...
  command {
    bcftools annotate \
      ${"--output " + if defined(outputFilename) then outputFilename else "generated-6fc06872-befa-11e9-a555-acde48001122.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-6fc05e36-befa-11e9-a555-acde48001122.vcf"
  }
}