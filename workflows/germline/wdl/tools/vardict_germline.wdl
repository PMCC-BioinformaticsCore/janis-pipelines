...
task vardict_germline {
  input {
    ...
    Int? runtime_memory
    File intervals
    String outputFilename = "generated-6fc020ec-befa-11e9-a555-acde48001122.vardict.vcf"
    File bam
    File bam_bai
    File reference
    File reference_fai
  ...
  command {
    VarDict \
      ...
      ${"> " + if defined(outputFilename) then outputFilename else "generated-6fc0317c-befa-11e9-a555-acde48001122.vardict.vcf"}
  }
  runtime {
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-6fc020ec-befa-11e9-a555-acde48001122.vardict.vcf"
  }
}