...
task vardict_somatic {
  input {
    ...
    String outputFilename = "generated-b6b40518-b1b2-11e9-8bf3-acde48001122.vardict.vcf"
  ...
  command {
    VarDict \
      ...
      -f ${alleleFreqThreshold} \
      ${"> " + if defined(outputFilename) then outputFilename else "generated-b6b42d54-b1b2-11e9-8bf3-acde48001122.vardict.vcf"}
  }
  runtime {
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-b6b40518-b1b2-11e9-8bf3-acde48001122.vardict.vcf"
  }
}