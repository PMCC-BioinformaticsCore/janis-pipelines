...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-b6b155f2-b1b2-11e9-8bf3-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-b6b155f2-b1b2-11e9-8bf3-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-b6b16b82-b1b2-11e9-8bf3-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-b6b16b82-b1b2-11e9-8bf3-acde48001122-R2.fastq.gz"} \
