...
task BwaMemSamtoolsView {
  input {
    ...
    Array[File] reads
    Array[File]? mates
    String outputFilename = "generated-b6b18a2c-b1b2-11e9-8bf3-acde48001122.bam"
    String sampleName
  ...
  command {
     \
      ...
      samtools \
      view \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-b6b1a2b4-b1b2-11e9-8bf3-acde48001122.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-b6b18a2c-b1b2-11e9-8bf3-acde48001122.bam"
  }
}