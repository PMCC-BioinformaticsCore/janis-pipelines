...
task bcftoolsAnnotate {
  input {
    ...
    Int? runtime_memory
    File file
    String outputFilename = "generated-b6b45d1a-b1b2-11e9-8bf3-acde48001122.vcf"
    File? annotations
    String? collapse
  ...
  command {
    bcftools annotate \
      ${"--output " + if defined(outputFilename) then outputFilename else "generated-b6b468dc-b1b2-11e9-8bf3-acde48001122.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-b6b45d1a-b1b2-11e9-8bf3-acde48001122.vcf"
  }
}