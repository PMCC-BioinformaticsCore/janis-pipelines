...
task Gatk4GatherVcfs {
  input {
    ...
    Int? runtime_memory
    Array[File] vcfs
    String outputFilename = "generated-b6b4bb3e-b1b2-11e9-8bf3-acde48001122.gathered.vcf"
  ...
  command {
    gatk GatherVcfs \
      ...
      ${"--OUTPUT " + if defined(outputFilename) then outputFilename else "generated-b6b4c5ac-b1b2-11e9-8bf3-acde48001122.gathered.vcf"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-b6b4bb3e-b1b2-11e9-8bf3-acde48001122.gathered.vcf"
  }
}