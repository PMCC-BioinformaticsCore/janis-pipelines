...
task Gatk4MergeSamFiles {
  input {
    ...
    Array[File] bams
    Array[File] bams_bai
    String outputFilename = "generated-b6b1f5a2-b1b2-11e9-8bf3-acde48001122.bam"
  ...
  command {
    gatk MergeSamFiles \
      ...
      ${sep=" " prefix("-I ", bams)} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-b6b2002e-b1b2-11e9-8bf3-acde48001122.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-b6b1f5a2-b1b2-11e9-8bf3-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-b6b1f5a2-b1b2-11e9-8bf3-acde48001122.bam", "\\.bam$", ".bai")
  }
}