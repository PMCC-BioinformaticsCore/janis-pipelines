...
task Gatk4MergeSamFiles {
  input {
    ...
    Array[File] bams
    Array[File] bams_bai
    String outputFilename = "generated-60d22202-c2dc-11e9-be0f-f218985ebfa7.bam"
  ...
  command {
    gatk MergeSamFiles \
      ...
      ${sep=" " prefix("-I ", bams)} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-60d22a7c-c2dc-11e9-be0f-f218985ebfa7.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-60d22202-c2dc-11e9-be0f-f218985ebfa7.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-60d22202-c2dc-11e9-be0f-f218985ebfa7.bam", "\\.bam$", ".bai")
  }
}