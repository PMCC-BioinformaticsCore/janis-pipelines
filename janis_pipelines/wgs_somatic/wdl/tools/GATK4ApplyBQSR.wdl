...
task GATK4ApplyBQSR {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-7ea129aa-0fca-11ea-b0f8-acde48001122.bam"
    File? recalFile
    File? intervals
    String? tmpDir
  }
  command {
    ...
    gatk ApplyBQSR \
      -R ${reference} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-7ea130c6-0fca-11ea-b0f8-acde48001122.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-7ea129aa-0fca-11ea-b0f8-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-7ea129aa-0fca-11ea-b0f8-acde48001122.bam", "\\.bam$", ".bai")
  }
}