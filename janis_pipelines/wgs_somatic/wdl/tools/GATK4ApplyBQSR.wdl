...
task GATK4ApplyBQSR {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-6c06802a-ea17-11e9-bda6-acde48001122.bam"
    File? recalFile
    File? intervals
    String? tmpDir
  }
  command {
    ...
    gatk ApplyBQSR \
      -R ${reference} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-6c0686c4-ea17-11e9-bda6-acde48001122.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-6c06802a-ea17-11e9-bda6-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-6c06802a-ea17-11e9-bda6-acde48001122.bam", "\\.bam$", ".bai")
  }
}