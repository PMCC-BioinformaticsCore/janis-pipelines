...
task gatk4sortsam {
  input {
    ...
    Int? runtime_memory
    File bam
    String outputFilename = "generated-7ea031a8-0fca-11ea-b0f8-acde48001122.bam"
    String sortOrder
  ...
  command {
    ...
    gatk SortSam \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-7ea03bc6-0fca-11ea-b0f8-acde48001122.bam"} \
      -SO ${sortOrder} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-7ea031a8-0fca-11ea-b0f8-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-7ea031a8-0fca-11ea-b0f8-acde48001122.bam", "\\.bam$", ".bai")
  }
}