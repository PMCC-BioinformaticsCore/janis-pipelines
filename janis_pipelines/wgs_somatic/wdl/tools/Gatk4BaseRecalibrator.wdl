...
task Gatk4BaseRecalibrator {
  input {
    ...
    File reference_fai
    File reference_dict
    String outputFilename = "generated-7ea0eed6-0fca-11ea-b0f8-acde48001122.table"
    File? intervals
  }
  command {
    ...
    gatk BaseRecalibrator \
      ...
      -R ${reference} \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-7ea0f75a-0fca-11ea-b0f8-acde48001122.table"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-7ea0eed6-0fca-11ea-b0f8-acde48001122.table"
  }
}