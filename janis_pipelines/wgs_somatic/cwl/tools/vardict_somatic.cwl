...
- position: 1
  prefix: -b
  shellQuote: true
  valueFrom: $("{tumorBam}|{normalBam}".replace(/\{tumorBam\}/g, inputs.tumorBam).replace(/\{normalBam\}/g,
    inputs.normalBam))
- position: 1
  prefix: -N
  shellQuote: true
...
- position: 5
  prefix: -N
  shellQuote: true
  valueFrom: $("{tumorName}|{normalName}".replace(/\{tumorName\}/g, inputs.tumorName).replace(/\{normalName\}/g,
    inputs.normalName))
- position: 5
  prefix: -f
  shellQuote: false
...
- doc: 'The threshold for allele frequency, default: 0.05 or 5%'
  ...
  - float
  - 'null'
- default: generated-689bcfb2-ea17-11e9-bda6-acde48001122.vardict.vcf
  id: outputFilename
  inputBinding:
    position: 10
    prefix: '>'
