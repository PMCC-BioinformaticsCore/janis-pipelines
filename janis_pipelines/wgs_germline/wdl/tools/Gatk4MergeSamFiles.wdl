...
task Gatk4MergeSamFiles {
  input {
    ...
    Array[File] bams
    Array[File] bams_bai
    String outputFilename = "generated-5bced78e-ea17-11e9-821d-acde48001122.bam"
  ...
  command {
    ...
    gatk MergeSamFiles \
      ...
      -I ${sep=" " bams} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-5bcee512-ea17-11e9-821d-acde48001122.bam"} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-5bced78e-ea17-11e9-821d-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-5bced78e-ea17-11e9-821d-acde48001122.bam", "\\.bam$", ".bai")
  }
}