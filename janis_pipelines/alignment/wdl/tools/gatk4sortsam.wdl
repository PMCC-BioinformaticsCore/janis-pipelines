...
task gatk4sortsam {
  input {
    ...
    Int? runtime_memory
    File bam
    String outputFilename = "generated-48d2d522-ea17-11e9-8b6a-acde48001122.bam"
    String sortOrder
  ...
  command {
    ...
    gatk SortSam \
      -I ${bam} \
      ${"-O " + if defined(outputFilename) then outputFilename else "generated-48d2dc7a-ea17-11e9-8b6a-acde48001122.bam"} \
      -SO ${sortOrder} \
  ...
  output {
    File out = if defined(outputFilename) then outputFilename else "generated-48d2d522-ea17-11e9-8b6a-acde48001122.bam"
    File out_bai = sub(if defined(outputFilename) then outputFilename else "generated-48d2d522-ea17-11e9-8b6a-acde48001122.bam", "\\.bam$", ".bai")
  }
}