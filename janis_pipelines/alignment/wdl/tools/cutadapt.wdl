...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-48d25a2a-ea17-11e9-8b6a-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-48d25a2a-ea17-11e9-8b6a-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-48d26fec-ea17-11e9-8b6a-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-48d26fec-ea17-11e9-8b6a-acde48001122-R2.fastq.gz"} \
