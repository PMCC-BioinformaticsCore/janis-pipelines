...
task cutadapt {
  input {
    ...
    Array[File] fastq
    String? adapter
    String outputFilename = "generated-7e973784-ea17-11e9-b34c-acde48001122-R1.fastq.gz"
    String secondReadFile = "generated-7e973784-ea17-11e9-b34c-acde48001122-R2.fastq.gz"
    Boolean? debug
    Boolean? noIndels
  ...
  command {
    cutadapt \
      ${"-a " + adapter} \
      ${"-o " + if defined(outputFilename) then outputFilename else "generated-7e9756d8-ea17-11e9-b34c-acde48001122-R1.fastq.gz"} \
      ${"-p " + if defined(secondReadFile) then secondReadFile else "generated-7e9756d8-ea17-11e9-b34c-acde48001122-R2.fastq.gz"} \
