...
class RNASeqGeneExpressionQuantificationQC(BioinformaticsWorkflow):
    def id(self):
        return "RNASeqGeneExpressionQuantificationQC"

    def friendly_name(self):
        return "RNASeq Gene Expression Quantification and QC"
    ...
    def bind_metadata(self):
        ...
        meta.short_documentation = (
            "mRNA Analysis Pipeline for Gene Expression, Quantification and QC (GDC)"
        )
        meta.documentation = """\
...
if __name__ == "__main__":
    RNASeqGeneExpressionQuantificationQC().translate("wdl")
